...
fn parse_vec3_or(s: &str, default: [f64; 3]) -> [f64; 3] {
...
/// Format an `f64` for XML emission. Values that passed through an `f32`
...
fn origin_rotation(o: &mn::Origin) -> na::UnitQuaternion<f64> {
...
fn config_iso(t: [f64; 3], q_xyzw: [f64; 4]) -> na::Isometry3<f64> {
...
fn color_spec_to_rgba(c: &mn::ColorSpec) -> [f32; 4] {
    match c {
...
fn resolve_visual_rgba(v: &mn::Visual, materials: &HashMap<&str, [f32; 4]>) -> [f32; 4] {
